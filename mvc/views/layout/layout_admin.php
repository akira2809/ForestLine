...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <?php require_once './mvc/views/admin/block/aside.php' ?>
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header">
                <?php
                if (file_exists("./mvc/views/admin/page/$page.php")) {
                    require_once "./mvc/views/admin/page/$page.php";
                } else {
                    require_once "./mvc/views/admin/page/dashboard.php";
                }
                ?>
            </div>
